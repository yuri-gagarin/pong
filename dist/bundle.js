...
var Ball = exports.Ball = function (_Rectangle2) {
  _inherits(Ball, _Rectangle2);

  function Ball() {
    _classCallCheck(this, Ball);

    var _this2 = _possibleConstructorReturn(this, (Ball.__proto__ || Object.getPrototypeOf(Ball)).call(this, 10, 10));

    _this2.velocity = new Vector();
    return _this2;
  }
...
var _pong_resources = __webpack_require__(4);
...
var Pong = function () {
  function Pong(canvas) {
    ...
    this.ball = new _pong_resources.Ball();
    ...
    var animateGame = function animateGame(miliseconds) {
      ...
      if (lastTime) {
        _this.updateGame((miliseconds - lastTime) / 1000);
      }
  ...
  _createClass(Pong, [{
    ...
    value: function updateGame(time) {
      ...
      this.players.forEach(function (player) {
        _this3.collideWithPaddle(player, _this3.ball);
      });
      this.renderGame();
    }
  }]);
...
module.exports = __webpack_require__.p + "node_modules/bootstrap/fonts/glyphicons-halflings-regular.woff";
